...
template<typename value_type>
inline __attribute__((always_inline)) constexpr std::enable_if_t<
    std::is_arithmetic_v<value_type>, value_type>
...
template<typename value_type>
inline __attribute__((always_inline)) constexpr std::enable_if_t<
    std::is_floating_point<value_type>::value, value_type>
...
template<typename value_type>
inline __attribute__((always_inline)) constexpr std::enable_if_t<
    std::is_floating_point_v<value_type>, value_type>
...
template<typename value_type>
inline __attribute__((always_inline)) constexpr std::enable_if_t<
    std::is_floating_point_v<value_type>, bool>
