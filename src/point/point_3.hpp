...
public:
    ...
    point()                    = default;
    point(value_type x, value_type y, value_type z) : x(x), y(y), z(z) { }
        ...
        switch (index)
        {
            ...
            default:
                throw std::out_of_range(
                    "p201::point::at: Element is out of range");
                break;
        }
    }
...
operator==(const point<value_type, 3>& one, const point<value_type, 3>& two)
{
