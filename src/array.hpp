...
template	<typename value_type, size_t __size>
array<value_type, __size>&	array<value_type, __size>::operator =(const st_array<value_type, __size>& other)
{
	memcpy(__data, other.__data, (__size > 0 ? __size : 1) * sizeof(value_type));
	return *this;
}
template	<typename value_type, size_t __size>
array<value_type, __size>&	array<value_type, __size>::operator =(st_array<value_type, __size>&& other)
{
	memcpy(__data, other.__data, (__size > 0 ? __size : 1) * sizeof(value_type));
	return *this;
}
