        ...
        void load_entity(class entity& entity, const std::string& name)
        {
            ...
            for (auto& component_pair : ptree.get_child("entity.components"))
            {
                ...
                switch (flag)
                {
                    ...
                    {
                        auto& render =
                            entity.add_component<components::render>();
                    ...
                    case component::flag::transform:
                    {
                        ...
                        transform.position.x() =
                            component.get<float>("position.x");
                        transform.position.y() =
                            component.get<float>("position.y");
                        transform.position.z() =
                            component.get<float>("position.z");
                        break;
                    }
                    case component::flag::movement:
                    {
                        ...
                        movement.velocity.x() =
                            component.get<float>("velocity.x");
                        movement.velocity.y() =
                            component.get<float>("velocity.y");
                        movement.velocity.z() =
                            component.get<float>("velocity.z");
        ...
        void save_entity(class entity& entity, const std::string& name)
        {
            ...
            for (std::size_t i = 0; i < entity.flag.size(); ++i)
            {
                ...
                switch (i)
                {
                    ...
                    {
                        auto& transform =
                            entity.component<components::transform>();
                    ...
                    {
                        auto& animation =
                            entity.component<components::animation>();
